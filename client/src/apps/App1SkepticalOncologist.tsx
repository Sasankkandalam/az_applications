      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col p-3 sm:p-4 md:p-6">
        ...
        <div className="bg-white/95 backdrop-blur rounded-xl sm:rounded-2xl border border-white/20 shadow-xl p-4 sm:p-5 mb-4">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <div className="flex items-center gap-3 mb-0.5">
                ...
                <div className="text-xs text-slate-500">Stage 1 of 3</div>
              </div>
          ...
          <div className="mt-3 bg-slate-100 rounded-full h-2">
            <div className="bg-gradient-to-r from-blue-500 to-cyan-500 h-2 rounded-full transition-all w-1/3" />
          </div>
        </div>

        {/* Research Cards + Action */}
        <div className="bg-white/95 backdrop-blur rounded-xl border border-slate-200 shadow-xl p-4">
                  ...
                  <div className={`${selected ? 'p-4 sm:p-5' : 'p-3 sm:p-4'}`}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-1.5 flex-shrink-0">
                        {selected && <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-blue-600 text-white">+{option.points} pts</span>}
          ...
          {selectedResearch.length < 2 && (
            <div className="bg-slate-50 rounded-xl border border-slate-100 p-3 text-center">
              <p className="text-slate-400 text-sm">Select at least 2 research tools to proceed</p>
            </div>
          )}
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-3 sm:p-4 md:p-6">
        <div className="bg-white/95 backdrop-blur rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-white/20 max-w-2xl w-full p-5 sm:p-7">
          <button type="button" onClick={() => navigate('/')} className="flex items-center gap-1.5 text-slate-500 hover:text-slate-700 text-sm mb-4 transition-colors"><ArrowLeft className="w-4 h-4" /> Home</button>
          {/* Header */}
          <div className="mb-5">
            <div className="flex items-center justify-between mb-1">
              <div className="text-xs text-slate-500">Stage 2 of 3</div>
              <div className="text-sm font-bold text-blue-600">Total Points: {score}</div>
            </div>
            ...
            <div className="mt-3 bg-slate-100 rounded-full h-2">
              <div className="bg-gradient-to-r from-blue-500 to-cyan-500 h-2 rounded-full w-2/3" />
            </div>
          </div>
